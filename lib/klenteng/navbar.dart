...
import 'package:cool_tourismapp/klenteng/history.dart';
import 'package:cool_tourismapp/klenteng/home.dart';
import 'package:cool_tourismapp/klenteng/todo.dart';
...
class _NavbarState extends State<Navbar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text('Klenteng Sanggar Agung'),
        ),
